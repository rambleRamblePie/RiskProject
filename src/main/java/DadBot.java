...
public class DadBot extends TelegramLongPollingBot{
    ...
    public void setupTelegramTerritories(){
        ...
        userList.get(0).addTerritory(board.getTerritoryName("Irkutsk"));
        board.setUserOccupant("Irkutsk", userList.get(0));
        board.getTerritoryName("Irkutsk").setArmyPower(1);
        userList.get(0).addTerritory(board.getTerritoryName("Yakutsk"));
        board.setUserOccupant("Yakutsk", userList.get(0));
        board.getTerritoryName("Yakutsk").setArmyPower(1);
        userList.get(0).addTerritory(board.getTerritoryName("Kamchatka"));
        board.setUserOccupant("Kamchatka", userList.get(0));
        board.getTerritoryName("Kamchatka").setArmyPower(1);
        userList.get(0).addTerritory(board.getTerritoryName("Siberia"));
        board.setUserOccupant("Siberia", userList.get(0));
        board.getTerritoryName("Siberia").setArmyPower(1);
        userList.get(0).addTerritory(board.getTerritoryName("Afghanistan"));
        board.setUserOccupant("Afghanistan", userList.get(0));
        board.getTerritoryName("Afghanistan").setArmyPower(1);
        userList.get(0).addTerritory(board.getTerritoryName("Ural"));
        board.setUserOccupant("Ural", userList.get(0));
        board.getTerritoryName("Ural").setArmyPower(1);
        userList.get(0).addTerritory(board.getTerritoryName("MiddleEast"));
        board.setUserOccupant("MiddleEast", userList.get(0));
        ...
        userList.get(2).addTerritory(board.getTerritoryName("EastAfrica"));
        board.setUserOccupant("EastAfrica", userList.get(2));
        board.getTerritoryName("EastAfrica").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("NorthernEurope"));
        board.setUserOccupant("NorthernEurope", userList.get(2));
        board.getTerritoryName("NorthernEurope").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("SouthernEurope"));
        board.setUserOccupant("SouthernEurope", userList.get(2));
        board.getTerritoryName("SouthernEurope").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("Western0Europe"));
        board.setUserOccupant("WesternEurope", userList.get(2));
        board.getTerritoryName("Western0Europe").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("Indonesia"));
        board.setUserOccupant("Indonesia", userList.get(2));
        board.getTerritoryName("Indonesia").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("NewGuinea"));
        board.setUserOccupant("NewGuinea", userList.get(2));
        board.getTerritoryName("NewGuinea").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("WesternAustralia"));
        board.setUserOccupant("WesternAustralia", userList.get(2));
        board.getTerritoryName("WesternAustralia").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("Siam"));
        board.setUserOccupant("Siam", userList.get(2));
        board.getTerritoryName("Siam").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("India"));
        board.setUserOccupant("India", userList.get(2));
        board.getTerritoryName("India").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("China"));
        board.setUserOccupant("China", userList.get(2));
        board.getTerritoryName("China").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("Mongolia"));
        board.setUserOccupant("Mongolia", userList.get(2));
        board.getTerritoryName("Mongolia").setArmyPower(1);
        userList.get(2).addTerritory(board.getTerritoryName("Peru"));
        board.setUserOccupant("Peru", userList.get(2));
